...
#            NodeNames.EXIT: NodeNames.EXIT,
    ...
    # From planner - always go to sql executor
    workflow.add_edge(NodeNames.VALIDATOR, NodeNames.SQL_EXECUTOR)

    # From sql executor - always go to output formatter
    workflow.add_edge(NodeNames.SQL_EXECUTOR, NodeNames.OUTPUT_FORMATTER)
